...
const Reports = () => {
  // Sample data for the chart (12 days from 01 Mar to 12 Mar 2025)
  const chartData = {
    labels: [
      "01 Mar",
      "02 Mar",
    ...
    datasets: [
      {
        ...
        backgroundColor: "rgba(255, 99, 132, 0.6)", // Pinkish color like the screenshot
      ...
      },
      {
        ...
        borderColor: "rgba(255, 159, 64, 1)", // Orange color like the screenshot
