...
// Updated CDN URLs for logos
const visaLogo = "https://www.logo.wine/a/logo/Visa_Inc./Visa_Inc.-Logo.wine.svg"; // Reliable Visa SVG
const mastercardLogo = "https://www.logo.wine/a/logo/Mastercard/Mastercard-Logo.wine.svg"; // Reliable Mastercard SVG
const stripeLogo = "https://stripe.com/img/v3/logo/black.png"; // Official Stripe logo
    ...
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            onClick={() => navigate(`/booking/${bookingData?.hotelId}/${bookingData?.roomType.toLowerCase().replace(" ", "")}`)}
